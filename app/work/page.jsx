...
const projects = [
  ...
  },
  {
    ...
    title: 'Storing and predicting rides Index values in Realtime',
    description: 'It stored real time rides and applications ',
    stack: [
      {
        name: 'Flutter',
      },
  ...
  },
  {
    ...
    category: 'Backend',
    title: 'LinkFreight',
    description: "it's transport goods and serivces",
    stack: [
      {
        name: 'next.js',
      },
  ...
  },
  {
    ...
    title: 'RideShare',
    description: 'A flutter application is uses to ridesharing platform',
    stack: [
      {
        name: 'Flutter',
      },
