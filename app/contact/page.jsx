...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+91) 7075531402",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "ridealottchandra@gmail.com",
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://sheetdb.io/api/v1/95xcllvhv5znb", {
        method: "POST",
        headers: {
          ...
          <div className="flex flex-col xl:flex-row gap-[30px]">
            <div className="xl:h-[54%] order-2 xl:order-none w-full xl:w-[50%]">
              <form method="POST" onSubmit={handleSubmit} className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
                ...
                I specialize in writing APIs using next.js and have solid skills in database management and SQL servers. I am also proficient in FLUTTER
                </p>
